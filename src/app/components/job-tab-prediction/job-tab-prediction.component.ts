...
@Component({
    selector: 'app-job-tab-prediction',
    templateUrl: './job-tab-prediction.component.html',
    styleUrls: ['./job-tab-prediction.component.scss'],
    standalone: true,
    imports: [TabMenuModule, PrimeTemplate, NgIf]
})
export class JobTabPredictionComponent implements OnChanges {
  @Input() tab: string;
